...
if (!html.includes('data-module="cost"')) throw new Error('cost module missing');
if (!html.includes('id="module-cost"')) throw new Error('cost panel missing');
if (!html.includes('id="cost-quote-download"')) throw new Error('original quote download button missing');
if (!html.includes('id="cost-lease-download"')) throw new Error('container lease download button missing');
if (!html.includes('./cost-calculator.js?v=')) throw new Error('cost calculator should use cache-busting version');
